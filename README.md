...
#### Requête WEB via serveur web HTTP 
...
Le serveur renvoie une erreur 400.

### 2. Un service d'infra

Une fois le serveur 1 mis en place, on le `curl` avec le client 1 afin de récupérer l'HTML. 


### 3. Serveur DHCP

La plage d'IP sera entre `10.6.201.20` et `10.6.201.50`.
On le serveur DHCP.
L'ip de `client1.tp6.b1` est maintenant `10.6.201.40`

```
    2: enp0s3: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500 qdisc pfifo_fast state UP group default qlen 1000
    link/ether 08:00:27:ad:41:08 brd ff:ff:ff:ff:ff:ff
    inet 10.6.201.50/24 brd 10.6.201.255 scope global noprefixroute dynamic enp0s3
       valid_lft 599sec preferred_lft 567sec
...
● named.service - Berkeley Internet Name Domain (DNS)
   ...
   Active: active (running) since Tue 2019-03-05 11:50:31 CET; 42min ago
 Main PID: 7203 (named)
